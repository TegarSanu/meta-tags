...
const FlyerManfaat = () => {
  return (
    <div className="w-full max-w-6xl flex mx-auto flex-col items-center justify-center text-black mt-16 z-10 px-7 md:px-0 pt-20 ">
      ...
      <div className="w-full flex gap-5 mt-10">
        <div className="w-[40%] bg-black rounded-xl text-white p-5">
          <div className="flex items-center gap-3">
            <FontAwesomeIcon icon={faPaperclip} />
            <p>Transparansi, Kontrol, dan Kepercayaan orang tua</p>
          </div>
          <Image alt="" />
        </div>
        <div className="w-[60%] bg-black rounded-xl text-white p-5">
          <div className="flex items-center gap-3">
            <FontAwesomeIcon icon={faStar} />
            <p>Transakasi dan data absensi otomatis</p>
          </div>
          <Image alt="" />
        </div>
      </div>
